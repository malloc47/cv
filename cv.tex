...
\begin{tabularx}{\linewidth}{@{}l X@{}}
  \textsc{Address}     & \footnotesize{600 W Chicago Ave. Suite 400} \\
                       & \footnotesize{C/O Groupon, Chicago, IL, 60654-2067} \\
...
\begin{tabularx}{\linewidth}{@{}r X l}
  \textsc{Aug. 2013} & Ph.D. Candidate in \textsc{Computer Science} & \textbf{University of South Carolina}\\
...
{Member of the Quantum Lead team developing internal tools for
    Groupon's sales workforce. Working in an agile environment using
    \clojure to develop service-oriented and big data systems. Built a
    specialized caching system, rearchitected existing \hadoop
    pipeline in \cascalog, and scaled a session management system used
    by a large machine-learning data pipeline.}
