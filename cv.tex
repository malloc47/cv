...
{www.github.com/malloc47/nonpartisan.me}
  ...
  \proj{Ratio Contour}{Maintainer of the Ratio Contour contour grouping project, created in C and MATLAB.}{www.github.com/malloc47/ratio-contour}

  \proj{Digital Collation}{Research project to ``collate'' high-resolution documents by using image registration, accomplished using the SIFT feature detector and a thin plate spline warping technique, written in MATLAB.}{www.github.com/malloc47/digital-collation}
