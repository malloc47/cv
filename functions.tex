...
\DeclareDocumentCommand \experience {m m m m o o o +m}{%
\begin{normalsize}
  \begin{tabularx}{\textwidth}{@{}l|Xll@{}}
    \multirow{\IfNoValueTF{#5}{1}{2}}{*}{\begin{large}\textsc{#1}\end{large}} & #2 & \textcolor{darkg}{#3} & \textcolor{darkg}{#4} \\
    \IfNoValueF{#5}{& #5 & \textcolor{darkg}{#6} & \textcolor{darkg}{#7}}
  \end{tabularx}
\end{normalsize}
