...
\newcommand{\rally}{
  ...
  {Staff-level engineering leader responsible for overseeing technical
    ...
    \item Coordinated with 20 internal and external teams and vendors
      across an extensive range of projects including productionalized
      ML workflows, frontend/mobile event tracking, real time data
