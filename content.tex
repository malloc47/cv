...
\newcommand{\optum}{
  ...
  {Brought in through acquisition of Rally Health, continuing as
    Architect for the former Rally data organization now housed within
...
\newcommand{\palmettocomputerlabs}{
  ...
  {Created and taught workshops on \git, the \linux command line,
    ...
    \institution{\href{https://it-ology.org/}{IT-oLogy}}.  Managed the
    \institution{\href{https://web.archive.org/web/20131104022533/http://open-it-lab.com/}{Open IT Lab}} and
    associated projects. Assisted in planning
    \institution{\href{https://posscon.org/}{POSSCON}}.}}
...
\newcommand{\volunteering}{
  ...
  {Spearheaded the conversion from \skill{Visual Basic 4} to
    ...
    \href{https://web.archive.org/web/20170614091024/http://www-01.sil.org/computing/ipahelp/ipaprvw2.htm}{IPA
      Help}. {[}\href{https://github.com/malloc47/ipa-help}{Code}{]}}}
...
\newcommand{\digitalcollation}{
  ...
  {Research project to ``collate'' high-resolution documents by using
    ...
    and a \href{https://en.wikipedia.org/wiki/Thin_plate_spline}{thin
      plate spline} warping technique, written in MATLAB.}%
...
\newcommand{\cockpit}{
  ...
  {Single-page web application dashboard deplayed on a wall-mounted
    ...
    \\
    {[}Blog Series: \href{https://www.malloc47.com/building-a-personal-dashboard-in-clojurescript}{malloc47.com/building-a-personal-dashboard-in-clojurescript}{]}}
